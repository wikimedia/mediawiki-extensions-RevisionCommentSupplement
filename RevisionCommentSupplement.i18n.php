...
$messages['ja'] = array(
	...
	'logentry-revisioncommentsupplement-create' => '$1 が第$4版の補足コメント $6 を作成しました',
	'logentry-revisioncommentsupplement-delete' => '$1 が第$4版の補足コメント $5 を削除しました',
	'logentry-revisioncommentsupplement-modify' => '$1 が第$4版の補足コメント $5 を $6 に変更しました',
	'revisioncommentsupplement' => '版のコメントの補足',
	'revcs-desc' => '履歴ページで、それぞれの版に補足コメントを表示できるようにする',
	'revcs-alert-exist-supplement' => '指定した版に対する補足コメントが存在します。',
	'revcs-alert-norevision' => '指定した版は、revisionテーブル内にありません。',
	'revcs-alert-revision-id' => '「$1」は間違った版IDです。',
	...
	'revcs-show-no-db-row' => '第$1版に対する補足コメントはありません。',
