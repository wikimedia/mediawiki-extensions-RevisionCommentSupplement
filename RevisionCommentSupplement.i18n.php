...
$messages['en'] = array(
	...
	'revcs-alert-nohistory' => "The history entry doesn't exist in the database table. This hasn't created yet, or has already deleted.",
	'revcs-alert-norevision' => "The revision doesn't exist in the revision table. This hasn't created yet, or has already deleted.",
	...
	'revcs-delete-desc' => "You can delete the supplementary comment from database table. Extension RevisionCommentSupplement doesn't provide undelete operation. If you would want to undelete, you had to restore from logs or history entries.",
	...
	'revcs-edit-show' => 'Show the supplementary comment',
	'revcs-edit-supplement' => 'Supplementary Comment:',
	'revcs-edit-written' => 'The supplementary comment is written.',
	'revcs-error' => 'Error: $1',
	'revcs-error-edit-denied' => 'denied saving the supplementary comment.',
	...
	'revcs-error-history-nosupplement' => "The supplementary comment doesn't exist in the database table. This hasn't created yet, or has already deleted.",
	'revcs-error-history-revision-id' => 'Revision ID is wrong.',
	'revcs-error-history-unuse' => "This wiki doesn't save history of supplementary comments.",
...
**Special:RevisionCommentSupplement/delete/$1. The link text is {{msg-mw|revcs-show-deletelinktext}}.',
	...
	'revcs-show-supplement-raw' => 'This message is used at show a supplementary comment of a revision in Special:RevisionCommentSupplement. $1 is a raw supplementary comment.',
...
$messages['de'] = array(
	...
	'revcs-alert-norevision' => 'Die Version ist in der Datenbanktabelle nicht vorhanden. Sie wurde noch nicht erstellt oder wurde bereits gelöscht.',
	...
	'revcs-error-edit-denied' => 'Das Speichern des ergänzenden Kommentars wurde verweigert.',
...
$messages['gl'] = array(
	...
	'revcs-alert-norevision' => 'non existe a revisión na táboa de revisións.', # Fuzzy
	...
	'revcs-alert-supplement-same-as-supplement' => 'o comentario suplementario é o mesmo texto có comentario suplementario da táboa da base de datos.', # Fuzzy
	'revcs-delete-desc' => 'Pode borrar o comentario suplementario da táboa da base de datos. Extension:RevisionCommentSupplement non dispón da opción de restauración. Se quixese restaurar o comentario, tería que facelo desde os rexistros.', # Fuzzy
	...
	'revcs-error' => 'Erro: $1',
	'revcs-error-edit-denied' => 'rexeitouse o gardado do comentario suplementario.',
	...
	'revcs-list-extended-comparison' => 'Operación de comparación:',
	'revcs-list-extended-comparison-and-over' => 'Os campos de índice son maiores ou iguais que a condición', # Fuzzy
	'revcs-list-extended-comparison-and-under' => 'Os campos de índice son menores ou iguais que a condición', # Fuzzy
	'revcs-list-extended-comparison-equal' => 'Os campos de índice son iguais que a condición', # Fuzzy
	'revcs-list-extended-comparison-not-equal' => 'Os campos de índice non son iguais que a condición', # Fuzzy
	'revcs-list-extended-comparison-over' => 'Os campos de índice son maiores que a condición', # Fuzzy
	'revcs-list-extended-comparison-under' => 'Os campos de índice son menores que a condición', # Fuzzy
	'revcs-list-extended-offset' => 'Cadea de comparación:', # Fuzzy
...
$messages['ja'] = array(
	...
	'revcs-delete-desc' => 'データベーステーブルから補足コメントを削除できます。RevisionCommentSupplement拡張機能は復帰操作を提供しません。削除された補足コメントを復帰させたい場合は、ログまたは履歴から復元する必要があります。',
	...
	'revcs-edit-written' => '補足コメントを書き込みました。',
	'revcs-error' => 'エラー: $1',
	...
	'revcs-list-extended-comparison-equal' => '事項が基準に等しい', # Fuzzy
...
$messages['ko'] = array(
	...
	'revcs-alert-norevision' => '판이 판 테이블에 존재하지 않습니다. 아직 만들어지지 않았거나 이미 삭제되었습니다.',
	...
	'revcs-edit-written' => '보충 의견을 적었습니다.',
	'revcs-error' => '오류: $1',
	'revcs-error-edit-denied' => '보충 덧글 저장을 거부했습니다.',
	...
	'revcs-log-hidehistory-unrestricted' => ' 제한 제거함',
